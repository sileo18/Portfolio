      ...
      <AnimatePresence>
        ...
        >
          <p className="text-3xl font-700 leading-snug md:text-left sm:text-center">
            Hi my name is Lucas, I am currently studying and seeking my first
            job!
          </p>

          <p className="text-lg font-400 leading-snug md:text-left sm:text-center">
            {" "}
            I am currently studying full stack development with a focus on
            TypeScript, Node.js and MySQL, but I also have a good familiarity
